...
A minimal implementation of HTMX that I am writing to understand how HTMX might work without looking at the HTMX source code. I also added a few custom attributes that I thought might be useful.
