...
<script runat="server">
	void Page_Load(object sender, EventArgs e)
	{
		if (Request["q"] != null)
		{
			string[] countries = { "afghanistan", "albania", "algeria", "andorra", "angola", "argentina", "armenia", "australia", "austria", "azerbaijan" };
			var results = countries.Where(country => country.Contains(Request["q"])).Select(result => "<li>" + result + "</li>");
			Response.Write(string.Join("", results));
			Response.End();
		}
	}
</script>
...
<body>
    ...
    <input id="autocomplete" type="text" hx-trigger="keyup" hx-get="index.aspx" hx-vals="js:{q: event.target.value}" hx-target="#autocomplete-results">
